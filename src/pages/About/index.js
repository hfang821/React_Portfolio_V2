                    ...
                    <Row style={{textAlign: 'center'}} id="block">
                        ...
                        <div style={{color: "white", marginTop:"7%",textAlign:"left", fontFamily:'Montserrat'}} id="intro">
                            ...
                            <div style={{marginTop:'20px'}}>
                                <p style={{display:'inline-block', position:'relative', bottom:'7px'}}><a href={Resume} target='_blank' style={{textDecoration: 'none', color:'inherit', fontSize:'20px', border:'0px', borderRadius:'6px', maxHeight: '45px', width:'8px'}}>Resume</a></p>
